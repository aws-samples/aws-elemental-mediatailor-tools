...
def lambda_handler(event, context):
    ...
    AdSegmentUrlPrefix = os.environ['AdSegmentUrlPrefix']
    ContentSegmentUrlPrefix = os.environ['ContentSegmentUrlPrefix']
    ...
    if event["RequestType"] == "Create" or event["RequestType"] == "Update":
        ...
        try:
            if AdSegmentUrlPrefix and ContentSegmentUrlPrefix: # setting up CDN
                response = client.put_playback_configuration( AdDecisionServerUrl=adServer,
                    Name=configName,
        ...
        try:
            ...
            response = client.delete_playback_configuration(Name=configName)
        except Exception as exp:
            print("Exception: %s" % exp)
            response = {"Exception": str(exp)}
            result = {
